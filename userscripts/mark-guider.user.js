...
(function() {
    ...
    // --- 1. Grade Predictor UI (Collapsible) ---
    function renderGradePredictor(targetTable, obtainedInCourse, isTheory) {
        ...
        const headerText = isTheory ? "Final Exam Targets (Paper mark out of 100)" : "Grade Targets (Remaining marks needed)";
